...
const UploadOrganizsationSetup=()=>{
...
toast,'/organization/setup/bulk-add/','organization-setup',
selectedFile,isFilePicked,
setSelectedFile,setIsFilePicked,dispatch
)
    return (
        <>
        <DrawerCloseButton />
        <DrawerHeader>Upload Organisation Structure In Batch</DrawerHeader>
        <DrawerBody>
...
export default UploadOrganizsationSetup