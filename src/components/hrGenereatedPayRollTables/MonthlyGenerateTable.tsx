...
const MonthlyGenerateTable=():React.ReactElement=>{
    ...
    const getAvailableDate = async ()=>{
        ...
        try {
            setIsLoading(true)
            const resp = await axios.get(`/client/${org_name}/payroll/monthly_generate/get_available_generated_dates/`)
...
export default MonthlyGenerateTable