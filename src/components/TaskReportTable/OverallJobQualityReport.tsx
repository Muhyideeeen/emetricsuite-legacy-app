...
const OverallJobQualityReport =({data}:Prop):React.ReactElement=>(
    ...
    overflow="hidden">
            <Thead bg="gray.200">
              <Tr>
               ...
               <Th py="5"  style={{"textTransform":"capitalize","padding":"0 2px","textAlign":"center"}}>Qly point</Th>
                 <Th  style={{"textTransform":"capitalize","padding":"0 2px","textAlign":"center"}}>Qly Point Score</Th>
                <Th></Th>
              </Tr>
            </Thead>
            <Tbody>
...
export default OverallJobQualityReport